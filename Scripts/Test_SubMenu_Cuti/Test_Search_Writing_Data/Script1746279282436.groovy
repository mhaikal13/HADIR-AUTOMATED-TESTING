...
WebUI.setText(findTestObject('Sub_Menu_Cuti/Search_Writing_Data_Cuti/Input_Start-EndDate_Cuti'), '12 Mar 2024')

WebUI.delay(2)

WebUI.setText(findTestObject('Sub_Menu_Cuti/Search_Writing_Data_Cuti/Input_Start-EndDate_Cuti'), '19 Agt 2024')
...
WebUI.setText(findTestObject('Sub_Menu_Cuti/Search_By_Callender_Cuti/Input_Unit_Cuti'), 'AMEX MERCHANT')
