...
WebUI.click(findTestObject('Sub_Menu_Kehadiran/input_manual_data/button_filter_negative'))

WebUI.delay(2)

WebUI.setText(findTestObject('Sub_Menu_Kehadiran/input_manual_data/input_departemen'), 'Amex')
...
WebUI.click(findTestObject('Sub_Menu_Kehadiran/input_manual_data/button_Terapkan2'))
